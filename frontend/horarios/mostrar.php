...
<div class="wrapper">
    ...
    <li class="breadcrumb-item active" aria-current="page">Mostrar</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Para crear un horario selecciona una subgrado</h4>
 ...
 $sentencia = $connect->prepare("SELECT subgrade.idsub,subgrade.state ,degree.iddeg, degree.nomgra, subgrade.nomsub, subgrade.fere, GROUP_CONCAT(period.idper, '..', period.numperi, '..' SEPARATOR '__') AS period  FROM subgrade INNER JOIN degree ON subgrade.iddeg = degree.iddeg INNER JOIN period ON period.idper = degree.idper  where subgrade.state='1' GROUP BY subgrade.idsub order by subgrade.idsub DESC;");
 $sentencia->execute();
      ...
      <thead class="text-primary">
       ...
       <tbody>
          ...
          <tr>
            ...
            <td><span class="badge badge-dq3"><?php echo  $g->nomgra; ?></span></td>
            <td><span class="badge badge-dbe"><?php echo  $g->nomsub; ?></span></td>
...
<?php    if($g->state =='1')  { ?> 
   ...
   <a href="../horarios/listado.php?id=<?php echo  $g->idsub; ?>" class="btn btn-warning text-white"
    ><i class='material-icons' data-toggle='tooltip' title='edit'>calendar_month</i></a> 
               <?php  }   else {?> 
