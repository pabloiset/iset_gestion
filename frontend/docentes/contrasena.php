    ...
    <li class="breadcrumb-item active" aria-current="page">Actualizar contraseña</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Actualizar contraseña del docente</h4>
...
<div class="row">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" id="nombres" value="<?php echo  $f->nomte; ?>"  readonly placeholder="ejm: laura">
</div>   
  </div>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="password"  class="form-control"  name="txtcntrstd"  placeholder="ejm: *******">
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdpswtea' class="btn btn-success text-white">Actualizar</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stpswteac.php'
?>
