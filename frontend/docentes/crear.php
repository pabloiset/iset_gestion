    ...
    <li class="breadcrumb-item active" aria-current="page">Crear perfil</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Crear perfil del alumno</h4>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    <label for="email">DNI del docente</label>
   
    <input type="text" maxlength="8" value="<?php echo  $f->dnite; ?>" class="form-control"  readonly placeholder="ejm: 76765654">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    <label for="email">Nombre del docente</label>
...
<div class="row">
 <div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Nombre de usuario del docente<span class="text-danger">*</span></label>
    <input type="text"  class="form-control"  name="txtuserte" required placeholder="ejm: docente98">
...
<div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Contraseña del docente<span class="text-danger">*</span></label>
    <input type="password"  class="form-control"  name="txtcntrte" required placeholder="ejm: *******">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
    </div>   
</div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stuusertea' class="btn btn-success text-white">Actualizar</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stusrteac.php'
?>
