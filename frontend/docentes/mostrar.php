  ...
  <li class="breadcrumb-item"><a href="../administrador/escritorio.php">Escritorio</a></li>
    ...
    <li class="breadcrumb-item active" aria-current="page">Mostrar</li>
                       ...
                       <div class="card" style="min-height:485px">
                           ...
                           <a href="../docentes/nuevo.php" class="btn btn-danger text-white"
...
if($sentencia){
  ...
  <table class="table table-hover" id="example">
      <thead class="text-primary">
       ...
       <tbody>
          ...
          <tr>
            <td><?php echo  $g->idtea; ?></td>
            <td><img src="../../backend/img/subidas/<?php echo $g->foto ?>" width='90'></td>
            <td><?php echo  $g->dnite; ?> </td>
            <td><?php echo  $g->nomte; ?></td>
            <td><a href="mail:<?php echo $g->correo ?>"><?php echo $g->correo ?></a></td>
            <td><a href="tel:<?php echo $g->telet ?>"><?php echo $g->telet ?></a></td>
    ...
    <a href="../docentes/actualizar.php?id=<?php echo  $g->idtea; ?>" class="btn btn-warning text-white"
    ><i class='material-icons' data-toggle='tooltip' title='edit'>warning</i></a>

    

    <a href="../docentes/eliminar.php?id=<?php echo  $g->idtea; ?>" class="btn btn-danger text-white"
    ><i class='material-icons' data-toggle='tooltip' title='delete'>delete_forever</i></a>


    <a href="../docentes/foto.php?id=<?php echo  $g->idtea; ?>" class="btn btn-info text-white"
  ...
  <a href="../docentes/info.php?id=<?php echo  $g->idtea; ?>" class="btn btn-primary text-white"
    ><i class='material-icons' data-toggle='tooltip' title='info'>info</i></a>
    <a href="../docentes/contrasena.php?id=<?php echo  $g->idtea; ?>" class="btn btn-success text-white"
    ><i class='material-icons' data-toggle='tooltip' title='password'>password</i></a>
               <?php  }   else {?> 
     <a href="../docentes/crear.php?id=<?php echo  $g->idtea; ?>" class="btn btn-dark text-white"
