    ...
    <li class="breadcrumb-item active" aria-current="page">Nuevo</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Nuevos docentes</h4>
...
<div class="row">
  <div class="col-md-6 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" maxlength="8" id="documento" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtdnite" required placeholder="ejm: 76765654">
  ...
  <div class="col-md-6 col-lg-4">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" id="nombres"  onkeypress="return soloLetras(event)" name="txtnamte" required placeholder="ejm: laura">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
  </div>
  <div class="col-md-6 col-lg-4">
...
<div class="row">
 <div class="col-md-6 col-lg-6">
  <div class="form-group">
    ...
    <input type="email"  class="form-control"  name="txtcorte" required placeholder="ejm: padre@gmail.com">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
 </div>
 ...
 <div class="col-md-6 col-lg-6">
  <div class="form-group">
    ...
    <input type="text" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control"  name="txttete" required placeholder="ejm: 998989876">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
 </div>
...
<div class="row">
    <div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Foto del docente<span class="text-danger">*</span></label>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddtea' class="btn btn-success text-white">Añadir</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stteac.php'
?>
