    ...
    <li class="breadcrumb-item active" aria-current="page">Actualizar</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Actualizar docentes</h4>
...
<div class="row">
  <div class="col-md-6 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" maxlength="8" value="<?php echo  $f->dnite; ?>" id="documento" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtdnit" required placeholder="ejm: 76765654">
    <input type="hidden" name="txtidte" value="<?php echo  $f->idtea; ?>">
  ...
  <div class="col-md-6 col-lg-4">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" id="nombres" value="<?php echo  $f->nomte; ?>" onkeypress="return soloLetras(event)" name="txtnamte" required placeholder="ejm: laura">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
  </div>
  <div class="col-md-6 col-lg-4">
    ...
    <select class="form-control" required name="txtse">
...
<div class="row">
 <div class="col-md-6 col-lg-">
  <div class="form-group">
    ...
    <input type="email" value="<?php echo  $f->correo; ?>" class="form-control"  name="txtcor" required placeholder="ejm: padre@gmail.com">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
 </div>
 ...
 <div class="col-md-6 col-lg-6">
  <div class="form-group">
    ...
    <input type="text" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control" value="<?php echo  $f->telet; ?>" name="txttete" required placeholder="ejm: 998989876">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
 </div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdtea' class="btn btn-success text-white">Actualizar</button>                       
            <a class="btn btn-danger text-white" href="../docentes/mostrar.php">Cancelar</a>
        </div>
</div>
</form> 
<?php endforeach; ?>
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stteac.php'
?>
