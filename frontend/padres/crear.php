...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    <label for="email">DNI del padre</label>
    <input type="text" readonly maxlength="8" id="documento" value="<?php echo  $f->dnifa; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtdnif"  placeholder="ejm: 76765654">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" value="<?php echo  $f->nomfa; ?>" name="txtnamfa" readonly placeholder="ejm: laura">
</div>   
  </div>
...
<div class="row">
 <div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Nombre de usuario del padre<span class="text-danger">*</span></label>
    <input type="text"  class="form-control"  name="txtuserfa" required placeholder="ejm: padre98">
...
<div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Contraseña del padre<span class="text-danger">*</span></label>
    <input type="password"  class="form-control"  name="txtcntrfa" required placeholder="ejm: *******">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
    </div>   
</div>
...
<div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Rol<span class="text-danger">*</span></label>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdusrfath' class="btn btn-success text-white">Crear perfil</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stusrfather.php'
?>
