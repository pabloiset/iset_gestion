...
<div class="row">
  <div class="col-md-6 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" maxlength="8" id="documento" value="<?php echo  $f->dnifa; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtdnif" required placeholder="ejm: 76765654">
    <input type="hidden" name="txtfaid" value="<?php echo  $f->idfa; ?>">
  ...
  <div class="col-md-6 col-lg-4">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" value="<?php echo  $f->nomfa; ?>" id="nombres"  onkeypress="return soloLetras(event)" name="txtnamfa" required placeholder="ejm: laura">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
  </div>
  <div class="col-md-6 col-lg-4">
    ...
    <input type="text"  class="form-control" value="<?php echo  $f->profefa; ?>" onkeypress="return soloLetras(event)" name="txtprofa" required placeholder="ejm: arquitectura">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>  
  </div>      
</div>
<div class="row">
 <div class="col-md-6 col-lg-4">
  <div class="form-group">
    ...
    <input type="email"  class="form-control" value="<?php echo  $f->correo; ?>" name="txtcorfa" required placeholder="ejm: padre@gmail.com">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
 </div>
 ...
 <div class="col-md-6 col-lg-4">
  <div class="form-group">
    ...
    <input type="text" maxlength="9" value="<?php echo  $f->telefa; ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control"  name="txttefa" required placeholder="ejm: 998989876">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
 </div>
 ...
 <div class="col-md-6 col-lg-4">
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?php echo  $f->direc; ?>" name="txtdirfa" required placeholder="ejm: av larco">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>   
 </div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdfath' class="btn btn-success text-white">Actualizar</button>                       
            <a class="btn btn-danger text-white" href="../padres/mostrar.php">Cancelar</a>
        </div>
</div>
</form> 
<?php endforeach; ?>
