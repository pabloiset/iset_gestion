    ...
    <li class="breadcrumb-item active" aria-current="page">Actualizar contraseña</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Actualizar contraseña de la familia</h4>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text" readonly  value="<?php echo  $f->dnifa; ?>" class="form-control"   placeholder="ejm: 76765654">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text" readonly class="form-control" value="<?php echo  $f->nomfa; ?>"   placeholder="ejm: laura">
</div>   
  </div>
</div>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="password"  class="form-control"  name="txtcntrfa"  placeholder="ejm: *******">
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdpswfath' class="btn btn-success text-white">Actualizar</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stpswdfather.php'
?>
