    ...
    <li class="breadcrumb-item active" aria-current="page">Foto</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Actualizar foto familia</h4>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text" readonly maxlength="8" id="documento" value="<?php echo  $f->dnifa; ?>" class="form-control" name="txtdnif"  placeholder="ejm: 76765654">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text" readonly class="form-control" value="<?php echo  $f->nomfa; ?>" id="nombres"   name="txtnamfa"  placeholder="ejm: laura">
</div>   
  </div>
</div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdftfath' class="btn btn-success text-white">Actualizar</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stftfather.php'
?>
