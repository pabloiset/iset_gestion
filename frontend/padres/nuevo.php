...
<div class="row">
  <div class="col-md-6 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" maxlength="8" id="documento" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtdnif" required placeholder="ejm: 76765654">
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddfath' class="btn btn-success text-white">Añadir</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stfather.php'
?>
