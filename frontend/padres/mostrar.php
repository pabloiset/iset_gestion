...
<div class="wrapper">
 ...
 $sentencia = $connect->prepare("SELECT * FROM fathers GROUP BY idfa DESC;");
 $sentencia->execute();
...
if($sentencia){
  ...
  <table class="table table-hover" id="example">
      <thead class="text-primary">
       ...
       <tbody>
          ...
          <tr>
            <td><?php echo  $g->idfa; ?></td>
            <td><img src="../../backend/img/subidas/<?php echo $g->foto ?>" width='90'></td>
            <td><?php echo  $g->dnifa; ?> </td>
            <td><?php echo  $g->nomfa; ?></td>
            <td><a href="mail:<?php echo $g->correo ?>"><?php echo $g->correo ?></a></td>
            <td><a href="tel:<?php echo $g->telefa ?>"><?php echo $g->telefa ?></a></td>
    ...
    <a href="../padres/actualizar.php?id=<?php echo  $g->idfa; ?>" class="btn btn-warning text-white"
    ><i class='material-icons' data-toggle='tooltip' title='edit'>warning</i></a>

    

    <a href="../padres/eliminar.php?id=<?php echo  $g->idfa; ?>" class="btn btn-danger text-white"
    ><i class='material-icons' data-toggle='tooltip' title='delete'>delete_forever</i></a>

    <a href="../padres/hijos.php?id=<?php echo  $g->idfa; ?>" class="btn btn-secondary text-white"
    ><i class='material-icons' data-toggle='tooltip' title='studen'>face</i></a>


   


    <a href="../padres/foto.php?id=<?php echo  $g->idfa; ?>" class="btn btn-info text-white"
  ...
  <a href="../padres/info.php?id=<?php echo  $g->idfa; ?>" class="btn btn-primary text-white"
    ><i class='material-icons' data-toggle='tooltip' title='info'>info</i></a>
    <a href="../padres/contrasena.php?id=<?php echo  $g->idfa; ?>" class="btn btn-success text-white"
    ><i class='material-icons' data-toggle='tooltip' title='password'>password</i></a>
               <?php  }   else {?> 
     <a href="../padres/crear.php?id=<?php echo  $g->idfa; ?>" class="btn btn-dark text-white"
    ><i class='material-icons' data-toggle='tooltip' title='crear'>group_add</i></a>
     <?php  } ?> 
