...
<nav aria-label="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="../administrador/escritorio.php">Escritorio</a></li>
    <li class="breadcrumb-item"><a href="../usuarios/mostrar.php">Usuarios</a></li>
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    ...
    <input type="text" class="form-control" value="<?php echo  $f->nombre; ?>" name="txtnamuse" required placeholder="ejm: 2022-1">
    <input type="hidden" name="txtuserid" value="<?php echo  $f->id; ?>">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
  </div>
  <div class="form-group">
    <label for="pwd">Usuario<span class="text-danger">*</span></label>
    <input type="text" class="form-control" value="<?php echo  $f->usuario  ; ?>" name="txtuser" required placeholder="ejm: Enero-Abril 2022">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
  </div>

  <div class="form-group">
    <label for="pwd">Correo<span class="text-danger">*</span></label>
    <input type="text" class="form-control" value="<?php echo  $f->correo  ; ?>" name="txtcorru" required placeholder="ejm: Enero-Abril 2022">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
  </div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupduser' class="btn btn-success text-white">Actualizar</button>                       
            <a class="btn btn-danger text-white" href="../usuarios/mostrar.php">Cancelar</a>
        </div>
    </div>
</form> 
<?php endforeach; ?>
...
<!----------html code compleate----------->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stuser.php'
?>
