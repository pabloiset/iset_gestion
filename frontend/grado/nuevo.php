...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
  <div class="row">
    ...
    <select class="form-control" id="prd" required name="txtprd">
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddgrde' class="btn btn-success text-white">Añadir</button>                       
...
<!----------html code compleate----------->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stgrad.php'
?>
