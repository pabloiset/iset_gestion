...
<?php
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT degree.iddeg, period.idper, period.numperi, period.starperi, period.endperi, period.nomperi, degree.nomgra, degree.fere FROM degree INNER JOIN period ON degree.idper = period.idper  WHERE degree.iddeg= '$id';");
 $sentencia->execute();
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stdltgrde' class="btn btn-success text-white">Desactivar</button>                       
...
<!----------html code compleate----------->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/del_stgrad.php'
?>
