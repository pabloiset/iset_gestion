  ...
  <li class="breadcrumb-item"><a href="../administrador/escritorio.php">Escritorio</a></li>
    ...
    <div class="card" style="min-height:485px">
     <div class="card-header card-header-text">
       <h4 class="card-title">Actualizar carrera</h4>  
     </div>
...
<?php
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT degree.iddeg, degree.state,period.idper, period.numperi, period.starperi, period.endperi, period.nomperi, degree.nomgra, degree.fere FROM degree INNER JOIN period ON degree.idper = period.idper  WHERE degree.iddeg= '$id';");
 $sentencia->execute();
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
  <div class="row">
    ...
    <select class="form-control" required name="txtprd">
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdgrde' class="btn btn-success text-white">Actualizar</button>                       
...
<!----------html code compleate----------->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stgrad.php'
?>
