    ...
    <li class="breadcrumb-item active" aria-current="page">Nuevo</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Nuevos alumnos</h4>
...
<div class="row">
  <div class="col-md-6 col-lg-4">
    ...
    <input type="text"  class="form-control"   name="txtdirst" required placeholder="ejm: av. larco">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>  
  </div>
  ...
  <div class="col-md-6 col-lg-4">
    ...
    <input type="email"  class="form-control" name="txtcorst" required placeholder="ejm: alumno@gmail.com">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>  
  </div>  
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddstud' class="btn btn-success text-white">Añadir</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stdnt.php'
?>
