...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text" readonly maxlength="8" value="<?php echo  $f->dnist; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"   placeholder="ejm: 76765654">
<input type="hidden" name="txtstid" value="<?php echo  $f->idstu; ?>">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" value="<?php echo  $f->nomstu; ?>" id="nombres"  onkeypress="return soloLetras(event)" name="txtnamst" readonly placeholder="ejm: laura">
</div>   
  </div>
</div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdftstud' class="btn btn-success text-white">Actualizar</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stftdnt.php'
?>
