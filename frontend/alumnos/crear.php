...
<div class="row">
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text" maxlength="8" value="<?php echo  $f->dnist; ?>"  class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtdnit" readonly placeholder="ejm: 76765654">
<input type="hidden" name="txtstid" value="<?php echo  $f->idstu; ?>">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" value="<?php echo  $f->nomstu; ?>" readonly placeholder="ejm: laura">
    </div>   
  </div>
...
<div class="row">
 <div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Nombre de usuario del alumno<span class="text-danger">*</span></label>
    <input type="text"  class="form-control"  name="txtuserstd" required placeholder="ejm: alumno98">
...
<div class="col-md-6 col-lg-4">
  <div class="form-group">
    <label for="email">Contraseña del alumno<span class="text-danger">*</span></label>
    <input type="password"  class="form-control"  name="txtcntrstd" required placeholder="ejm: *******">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
    </div>   
</div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdusrstud' class="btn btn-success text-white">Crear perfil</button>                       
...
<!----------html code compleate----------->
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stusrdnt.php'
?>
