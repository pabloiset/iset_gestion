  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Mostrar</li>
                       ...
                       <div class="card" style="min-height:485px">
                           ...
                           <a href="../alumnos/nuevo.php" class="btn btn-danger text-white"
...
if($sentencia){
  ...
  <table class="table table-hover" id="example">
    ...
    <a href="../alumnos/actualizar.php?id=<?php echo  $g->idstu; ?>" class="btn btn-warning text-white"
    ><i class='material-icons' data-toggle='tooltip' title='edit'>warning</i></a>

    

    <a href="../alumnos/eliminar.php?id=<?php echo  $g->idstu; ?>" class="btn btn-danger text-white"
    ><i class='material-icons' data-toggle='tooltip' title='delete'>delete_forever</i></a>



    <a href="../alumnos/foto.php?id=<?php echo  $g->idstu; ?>" class="btn btn-info text-white"
  ...
  <a href="../alumnos/info.php?id=<?php echo  $g->idstu; ?>" class="btn btn-primary text-white"
    ><i class='material-icons' data-toggle='tooltip' title='info'>info</i></a>

    <a href="../alumnos/contrasena.php?id=<?php echo  $g->idstu; ?>" class="btn btn-success text-white"
    ><i class='material-icons' data-toggle='tooltip' title='password'>password</i></a>

               <?php  }   else {?> 
     <a href="../alumnos/crear.php?id=<?php echo  $g->idstu; ?>" class="btn btn-dark text-white"
