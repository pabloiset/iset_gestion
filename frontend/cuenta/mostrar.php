...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    <div class="form-group">
        <label class="col-md-12">Nombre del perfil<span class="text-danger">*</span></label>
            <div class="col-md-12">
                <input type="text"  name="txtnam" value="<?php echo  $d->nombre; ?>"  required placeholder="ejm: merlin"
    ...
    <div class="form-group">
        <label class="col-md-12">Correo electronico<span class="text-danger">*</span></label>
            <div class="col-md-12">
                <input type="email" name="txtemai" value="<?php echo  $d->correo; ?>"  required placeholder="ejm: merlin"
                    class="form-control form-control-line">
            </div>
    </div>

    <div class="form-group">
        <label class="col-md-12">Usuario del perfil<span class="text-danger">*</span></label>
            <div class="col-md-12">
                <input type="text" name="txtuser" value="<?php echo  $d->usuario; ?>"  required placeholder="ejm: merlin"
                    class="form-control form-control-line">
            </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-sm-12">
            <button name='stupdprofl' class="btn btn-success text-white">Actualizar</button>                       
...
<div class="form-group">
  ...
  <hr>
    <div class="form-group">
        <div class="col-sm-12">
            <button name='stupdpswpro' class="btn btn-success text-white">Actualizar</button>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stprof.php'
?>
<?php
    include_once '../../backend/php/upd_stuserftp.php'
?>
<?php
    include_once '../../backend/php/upd_stpswprof.php'
?>
<script>
