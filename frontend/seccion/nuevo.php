...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <div class="row">
    ...
    <input type="text" maxlength="2" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control"  name="txtcapc" required placeholder="ejm: 10">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>    
    </div>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddsection'  class="btn btn-success text-white">Añadir</button>                       
...
<!----------html code compleate----------->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stsection.php'
?>
...
<script src="../../backend/js/prda.js"></script>
<script src="../../backend/js/dct.js"></script>
