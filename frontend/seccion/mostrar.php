  ...
  <li class="breadcrumb-item"><a href="../administrador/escritorio.php">Escritorio</a></li>
    ...
    <li class="breadcrumb-item active" aria-current="page">Mostrar</li>
                       ...
                       <div class="card" style="min-height:485px">
                           ...
                           <a href="../seccion/nuevo.php" class="btn btn-danger text-white"
...
if($sentencia){
  ...
  <table class="table table-hover" id="example">
      <thead class="text-primary">
       ...
       <tbody>
          ...
          <tr>
            ...
            <?php foreach(explode("__", $g->period) as $peridConcatenados){ 
                                $period = explode("..", $peridConcatenados)
                                ?>
                               <td><span class="badge badge-dbe"><?php echo $period[1] ?></span></td>
                               
                <?php } ?>

           
            <td><span class="badge badge-dq3"><?php echo  $g->nomsec; ?></span></td>
            <?php foreach(explode("__", $g->degree) as $periodoConcatenados){ 
                                $degree = explode("..", $periodoConcatenados)
                                ?>
                               <td><span class="badge badge-cekj"><?php echo $degree[1] ?></span></td>
                               
                <?php } ?>

            <td><span class="badge badge-success"><?php echo $g->nomsub ?></span></td>
            <td><span class="badge badge-dfae"><?php echo $g->nomcur ?></span></td>

            <?php foreach(explode("__", $g->teachers) as $teaConcatenados){ 
                                $teachers = explode("..", $teaConcatenados)
                                ?>
                               <td><span class="badge badge-danger"><?php echo $teachers[1] ?></span></td>
                               
                <?php } ?>

            <td><span class="badge badge-darkr"><?php echo $g->capa ?></span></td>
    ...
    <a href="../seccion/actualizar.php?id=<?php echo  $g->idsec; ?>" class="btn btn-warning text-white"
    ><i class='material-icons' data-toggle='tooltip' title='edit'>warning</i></a>

    <a href="../seccion/eliminar.php?id=<?php echo  $g->idsec; ?>" class="btn btn-danger text-white"
    ><i class='material-icons' data-toggle='tooltip' title='delete'>delete_forever</i></a>

    <a href="../seccion/entrar.php?id=<?php echo  $g->idsec; ?>" class="btn btn-dark text-white"
    ><i class='material-icons' data-toggle='tooltip' title='logout'>logout</i></a>
