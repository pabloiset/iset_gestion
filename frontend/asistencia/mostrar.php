...
<div class="wrapper">
  ...
  <li class="breadcrumb-item"><a href="../administrador/escritorio.php">Escritorio</a></li>
    <li class="breadcrumb-item"><a href="../asistencia/mostrar.php">Asistencia</a></li>
    <li class="breadcrumb-item active" aria-current="page">Mostrar</li>
  </ol>
</nav>
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Listado de asistencia por cada docente</h4>
...
<div class="card" style="min-height:485px">
 ...
 $sentencia = $connect->prepare("SELECT asisten_alumn.idasisa, students.idstu, students.dnist, students.nomstu, students.correo, teachers.idtea, teachers.dnite, teachers.nomte, teachers.telet, seccion.idsec, seccion.nomsec, semester.idsems, semester.namsems,asisten_alumn.presen, asisten_alumn.fecha_create, GROUP_CONCAT(period.idper, '..', period.numperi, '..' SEPARATOR '__') AS period  FROM asisten_alumn INNER JOIN students ON asisten_alumn.idstu = students.idstu INNER JOIN teachers ON asisten_alumn.idtea = teachers.idtea INNER JOIN seccion ON  asisten_alumn.idsec = seccion.idsec  INNER JOIN semester ON asisten_alumn.idsems = semester.idsems INNER JOIN period ON semester.idper = period.idper GROUP BY asisten_alumn.idasisa order by asisten_alumn.idasisa DESC;");
 $sentencia->execute();
