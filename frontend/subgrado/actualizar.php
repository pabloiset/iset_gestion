...
<div class="card" style="min-height:485px">
     <div class="card-header card-header-text">
       <h4 class="card-title">Actualizar subgrado</h4>  
     </div>
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
  <div class="row">
    ...
    <select class="form-control" onchange="showselect(this.value)" required >
      
      <?php foreach(explode("__", $f->period) as $periodoConcatenados){ 
            $period = explode("..", $periodoConcatenados)
            ?>         
        <option value="<?php echo $period[1] ?>"><?php echo $period[1] ?></option>
    <?php } ?>
  ...
  <div class="col-md-6 col-lg-6">
    ...
    <select class="form-control" required name="txtgrd" id="periodo">
  ...
  <div class="row">
    ...
    <input type="text" value="<?php echo  $f->nomsub; ?>" class="form-control"  name="txtnamsgrd" required placeholder="ejm: Inicial de 5 años">
    <input type="hidden" name="txtidsgrd" value="<?php echo  $f->idsub; ?>">
    <small id="emailHelp" class="form-text text-muted"><span class="text-danger">Importante rellenar los campos.</span></small>
</div>    
    </div>
    <div class="col-md-6 col-lg-6">
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdsgrde' class="btn btn-success text-white">Actualizar</button>                       
            <a class="btn btn-danger text-white" href="../subgrado/mostrar.php">Cancelar</a>
        </div>
</div>  
</form>
...
<!----------html code compleate----------->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stsgrad.php'
?>
