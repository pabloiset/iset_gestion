  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Mostrar</li>
                       ...
                       <div class="card" style="min-height:485px">
                           ...
                           <a href="../subgrado/nuevo.php" class="btn btn-danger text-white"
  ...
  <table class="table table-hover" id="example">
      <thead class="text-primary">
       ...
       <tbody>
          ...
          <tr>
            <td><?php echo  $g->idsub; ?></td>
            <?php foreach(explode("__", $g->period) as $periodoConcatenados){ 
                                $period = explode("..", $periodoConcatenados)
                                ?>
                               <td><span class="badge badge-dfae"><?php echo $period[1] ?></span></td>
    ...
    <a href="../subgrado/actualizar.php?id=<?php echo  $g->idsub; ?>" class="btn btn-warning text-white"
    ><i class='material-icons' data-toggle='tooltip' title='edit'>warning</i></a> 

    <a href="../subgrado/eliminar.php?id=<?php echo  $g->idsub; ?>" class="btn btn-danger text-white"
