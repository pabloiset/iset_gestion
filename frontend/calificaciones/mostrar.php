    ...
    <li class="breadcrumb-item active" aria-current="page">Mostrar</li>
                       ...
                       <div class="card" style="min-height:485px">
                           <div class="card-header card-header-text">
                               <h4 class="card-title">Listado de calificaciones por cada docente</h4>
...
<div class="card" style="min-height:485px">
 ...
 $sentencia = $connect->prepare("SELECT alum_cali.idnta, semester.idsems, semester.namsems, students.idstu, students.dnist, students.nomstu, students.correo, seccion.idsec, seccion.nomsec, course.idcur, course.nomcur, alum_cali.prm, alum_cali.srm, alum_cali.trm, alum_cali.sug, alum_cali.state , GROUP_CONCAT(period.idper, '..', period.numperi, '..' SEPARATOR '__') AS period , GROUP_CONCAT(teachers.idtea, '..', teachers.nomte, '..' SEPARATOR '__') AS teachers FROM alum_cali INNER JOIN semester ON alum_cali.idsems = semester.idsems INNER JOIN students ON alum_cali.idstu = students.idstu INNER JOIN seccion ON alum_cali.idsec = seccion.idsec INNER JOIN course ON alum_cali.idcur = course.idcur INNER JOIN period ON course.idper=  period.idper INNER JOIN teachers ON course.idtea = teachers.idtea GROUP BY alum_cali.idnta order by alum_cali.idnta DESC;");
 $sentencia->execute();
