...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
  <div class="row">
    ...
    <select class="form-control" id="prd" name="txtnper" required>
 ...
 <div class="col-md-6 col-lg-6">
    ...
    <select class="form-control" id="docn" required name="txtdoc">
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddcourse' class="btn btn-success text-white">Añadir</button>                       
...
<!----------html code compleate----------->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stcourse.php'
?>
